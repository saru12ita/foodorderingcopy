...
<body>
	<div align="center" class="bg-dark text-light pt-4 pb-4">
		...
		<a href="../Home.php"><button style="float: left;" class="btn btn-success ml-3">HOME</button></a>
	...
	<div align="center" class="mt-5 abc" style="padding-top: 50px;">
		...
		<a href="shopping cart\shopping cart\cart.php"><button class="btn btn-lg btn-primary">ORDER DETAIL</button></a><br><br>
