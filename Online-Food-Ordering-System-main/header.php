...
<head>
	...
	<style>
		...
		.inner-menu{
			...
			color: #fff;
			height: 25px;
			background-image: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url('home.png');
...
<body>
	<div class="main-menu sticky-top">
		<div class="logo">
			<img src="dataimg\logo.png" class="img-fluid">
		</div>
		<div class="inner-menu sticky-top">
			<a href="index.php" style="float: left;">HOME</a>
			<a href="admin\addnewitem.php" style="float: right;">CART 
			<?php
